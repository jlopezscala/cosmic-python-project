...
from app.model.model import Batch, OrderLine
...
def test_allocating_to_a_batch_reduces_the_available_quantity():
    # Given
    batch = Batch(eta=today, sku=22, quantity=12)
...
def test_cannot_allocate_if_available_smaller_than_required():
    # Given
    batch = Batch(eta=today, sku=22, quantity=2)
...
def test_can_allocate_if_available_equal_to_required():
    # Given
    batch = Batch(eta=today, sku=22, quantity=3)
...
def test_cannot_allocate_different_skus():
    # Given
    batch = Batch(eta=today, sku=20, quantity=2)
...
def test_can_only_deallocate_existing_lines():
    batch = Batch(eta=today, sku=20, quantity=6)
